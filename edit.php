...
<section class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
								...
								<li role="presentation" class="active"><a href="#update" data-toggle="tab">UPDATE EXPENSE ITEMS</a></li>
								...
								<form method="POST">
                                    <b>Update Expense Item</b>
										...
										<?php
											...
											$query=mysqli_query ($con, "select * from expense_item_tbl where expense_id = $item_idd ORDER BY expense_id ASC");
											$result=mysqli_fetch_row($query);
										...
										?>	
											...
											<tbody> 
												...
												<td><input type="text" name="newname" min="1" max="20" value="<?php echo $result[1]; ?>" required></td>
												<td><input type="submit" class="waves-effect waves-light btn modal-trigger" name="editsaved" value="SAVE"></td>
												</tr>
	...
	<?php
		...
		{	
			...
			$new=$_POST['newname'];
			$item_idd=$_SESSION['e_id'];
			$queryup=mysqli_query($con,"update expense_item_tbl set expense_name='$new' where expense_id='$item_idd'");	
			echo'<script>alert("EXPENSE NAME UPDATED!");</script>';
