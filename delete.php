...
<section class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                           ...
                           <ul class="nav nav-tabs tab-nav-right" role="tablist">
								<li role="presentation" ><a href="#view" data-toggle="tab">VIEW EXPENSE ITEM</a></li>
								<li role="presentation" ><a href="#update" data-toggle="tab">UPDATE EXPENSE ITEMS</a></li>
								<li role="presentation" class="active" ><a href="#delete" data-toggle="tab">DELETE EXPENSE ITEM</a></li>
                            ...
                            <div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane fade in active" id="delete">
								<form method="POST">
                                    <b>	Delete Expense Item</b>
										...
										<?php 
											...
											$item_idd=$_SESSION['e_id'];
											$queryy=mysqli_query ($con, "select * from expense_item_tbl where expense_id = $item_idd ORDER BY expense_id ASC");
											$resultt=mysqli_fetch_row($queryy);
											//echo ("<script> window.location.href=('edit.php'); </script>");
										?>	
											<thead>
												<tr>
												<th scope="row">EXPENSE ITEM ID</th>
											...
											<tbody> 
												<tr>
												<td><?php echo $resultt[0]; ?></td>
												<td><?php echo $resultt[1]; ?></td>
												<td><input type="submit" class="waves-effect waves-light btn modal-trigger" name="delete" value="DELETE"></td>
												</tr>
	...
	<?php
		...
		{	
			...
			$item_idd=$_SESSION['e_id'];
			$query=mysqli_query($con,"delete from expense_item_tbl where expense_id='$item_idd'");	
			echo'<script>alert("EXPENSE NAME DELETED!");</script>';
			echo'<script>location="expense_item.php"</script>';
